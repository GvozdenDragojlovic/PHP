...
if(isset($_POST['izmeni'])){
    ...
    if($db->azuriraj($telefon, $cena , $akcija)){
        $poruka = "Uspesno azuriran telefon";
    }else{
        $poruka = "Neuspesno azuriran telefon";
    }
...
<body>
                ...
                <form method="post" action="">
                    ...
                    <select id="telefon" name="telefon" class="form-control">
                        ...
                        foreach ($telefoni as $telefon){
                            ?>
                        <option value="<?= $telefon->id ?>"><?= $telefon->proizvodjac . " " . $telefon->model . " - " . $telefon->cena ?>€</option>
                        <?php
                        }
                        ?>
                    </select>
                    ...
                    <hr/>
                    <center><button class="BtnForm" type="submit" name="izmeni">Izmeni uredjaj</button></center>
    ...
    <div><img id="android3" src="img/and.png"></div>
    <div id="lineH"></div>
    <div id = "footer"></div>                
